        ...
        <section class="base">
          ...
          <div>
            ...
            <td>
              ...
              <input type="radio" name="kelas" value="XI TKJ 4"> XI TKJ 4  
              <input type="radio" name="kelas" value="XI TKJ 5"> XI TKJ 5  
              <input type="radio" name="kelas" value="XI TKJ 6"> XI TKJ 6  
            </td>
          </div>
          <div>
            <label>Foto</label>
